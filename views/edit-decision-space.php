		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				...
				<form method="post" class="frm-main" name="profile" id="profile" novalidate="novalidate" autocomplete="off" ng-model="profile" enctype="multipart/form-data" action="scripts/process.php">
					...
					<input type="hidden" name="decision_space_id" id="decision_space_id" value="{{formData.id}}" />
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<textarea class="wysiswyg-editor" name="description" id="description" placeholder="Description" value="" ng-model="formData.description">{{formData.description}}</textarea>
						</div>
					</div>
					...
					<div class="row" style="margin-top:15px;">
						<div class="col-sm-12">
							...
							<a href='{{formData.SITE_URL}}uploads/{{path}}' target="_blank" ng-show="path">View File</a>
						</div>
					</div>
					<!--<div class="row">
						<div class="col-sm-12">
					...
					<div class="row">
						<div class="col-sm-6">
							<button type="submit" class="btn btn-md btn-primary" data-ng-disabled="profile.$pending || profile.$invalid || loading" ng-class="{ 'disabled-button' : profile.$invalid }"><i class="glyphicon glyphicon-refresh glyphicon-refresh-animate" data-ng-show="profile.$pending || loading"></i> Update</button>
						</div>
						<div class="col-sm-6">
